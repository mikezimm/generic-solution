...
import { PreConfigViews } from './viewsPreConfig';  //Import view arrays for Project list
...
export function defineTheList ( template: IValidTemplate , listTitle : string, listDefinition: 'Drilldown' | 'Drilldown' , webURL: string, currentUser:  number[], pageURL: string ) {
