...
export function buildFormFields(parentProps:IGenericWebpartProps , parentState: IGenericWebpartState ){
...
export function buildProjectFormFields(parentProps:IGenericWebpartProps , parentState: IGenericWebpartState ){
