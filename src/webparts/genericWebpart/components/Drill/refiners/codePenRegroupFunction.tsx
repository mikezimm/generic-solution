const { CommandBarButton, ResizeGroup, OverflowSet, IOverflowSetStyles, IContextualMenuItem, Dropdown, IDropdownOption, mergeStyleSets, Toggle, Fabric, initializeIcons } = window.Fabric;
...
const ResizeGroupOverflowSetExample: React.FunctionComponent = () => {
...
const ResizeGroupOverflowSetExampleWrapper = () => <Fabric><ResizeGroupOverflowSetExample /></Fabric>;
ReactDOM.render(<ResizeGroupOverflowSetExampleWrapper />, document.getElementById('content'))